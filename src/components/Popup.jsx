        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div
              ...
              rounded-xl overflow-hidden shadow-xl px-10 pt-8 pb-10 
              transform transition-all sm:align-middle 
              sm:max-w-full ${width}`}
            >
              <XIcon
                className="h-8 w-8 absolute right-6 top-6 hover:opacity-70 cursor-pointer transition duration-200"
                onClick={() => setPopupVisible(false)}
              />
              <Dialog.Title
                as="h3"
                className="text-2xl uppercase leading-5 text-cyan-200 font-bold pb-8"
              >
                {title}
              </Dialog.Title>
